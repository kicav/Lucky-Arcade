...
@section('content')
<div class="page-head"><div><span class="eyebrow">GAME LOBBY</span><h1>Choose a game</h1></div><div class="balance"><span>Balance</span><strong data-live-balance>{{ number_format(auth()->user()->wallet->balance) }}</strong></div></div>
